...
build_ci: build build/decimal_add.ci build/decimal_add_v001.ci build/decimal_div.ci build/decimal_div_v001.ci build/decimal_div_v002.ci build/decimal_div_v003.ci build/decimal_div_v004.ci build/decimal_div_v005.ci build/decimal_div_v006.ci build/decimal_div_v007.ci build/decimal_inc_and_dec.ci build/decimal_matrix_base_conversion.ci build/decimal_mult.ci build/decimal_print.ci build/decimal_print_raw.ci build/decimal_shift.ci build/decimal_sub_and_neg.ci build/decimal_tests.ci build/decimal_tilde.ci build/decimal_token_env.ci build/lib__01__pre_header.ci build/lib__02__header.ci build/lib__03.ci build/lib__04__string_stack.ci build/lib__05__error_state.ci build/lib__06__exception.ci build/main_old.ci build/main_options.ci build/main_tests.ci build/oldies.ci build/sc_line_max.ci 
...
build/decimal_matrix_base_conversion.ci: src/decimal_matrix_base_conversion.ci 
	ln src/decimal_matrix_base_conversion.ci build/decimal_matrix_base_conversion.ci 
...
build/decimal_print_raw.ci: src/decimal_print_raw.ci 
	ln src/decimal_print_raw.ci build/decimal_print_raw.ci 
...
build/decimal.i: build/decimal.c build/lib__01__pre_header.ci build/lib__02__header.ci build/lib__03.ci build/lib__04__string_stack.ci build/lib__05__error_state.ci build/lib__06__exception.ci build/decimal_global.h build/decimal.h build/decimal_print_raw.ci build/decimal_matrix_base_conversion.ci build/decimal_print.ci build/decimal_inc_and_dec.ci build/decimal_shift.ci build/decimal_tilde.ci build/decimal_add.ci build/decimal_sub_and_neg.ci build/decimal_mult.ci build/decimal_div.ci build/decimal_tests.ci 
